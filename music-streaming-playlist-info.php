...
$sql_playlist_info = "SELECT p.playlist_id, p.playlist_name, p.playlist_avatar_url, p.is_public, u.User_name, u.User_avatar_url 
                      FROM Playlists p 
...
<body>
        ...
        <div class="home">
            ...
            <div style="margin-bottom: 20px; cursor: pointer;">
                <div class="playlist-header">
                    <img class="playlist-image" src="<?php echo htmlspecialchars($playlistInfo['Playlist_avatar_url'] ?? './img/default-playlist-avatar.jpg'); ?>" alt="cover">
                    <div class="playlist-name">
                        ...
                        <div style="margin-top: 0px; grid-template-columns: 30px 100px auto; display: grid; align-content: center;">
                            <img style="width: 30px; height: 30px; border-radius: 30px;" src="<?php echo htmlspecialchars($playlistInfo['User_avatar_url'] ?? './img/avatar.jpg'); ?>" alt="user">
            ...
            <div>
                <table class="playlist-table">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="3" style="text-align: center; padding: 20px; color: #b3b3b3; width: 600px;">Playlist này chưa có bài hát nào.</td>
                        </tr>
                    <?php endif; ?>
                </table>
    ...
    <div class="edit_playlist_popup" id="edit_playlist_popup">
        ...
        <div style="grid-template-columns: 240px 330px; gap: 30px; display: grid;">
            <div style="margin-left: 30px;">
                <div style="width: 200px; height: 200px; border: 3px solid black; justify-content: center; align-items: center; overflow: hidden; display: flex;" id="avatar-preview">
                    <img src="<?php echo htmlspecialchars($playlistInfo['playlist_avatar_url'] ?? './img/default-playlist-avatar.jpg'); ?>" style="width: 200px; height: 200px; border: 3px solid black; object-fit: cover;">
                </div>
        ...
        <div style="grid-template-columns: 240px 150px 150px; gap: 30px; display: grid; margin-top: 10px;">
            <button type="button" class="changeSeenMode" id="changeSeenMode"><?php echo (isset($playlistInfo['is_public']) && $playlistInfo['is_public']) ? '🔓 Public' : '🔒 Private'; ?></button>
            <button type="button" class="createPlaylist" id="createPlaylist" style="width: 80%; height: fit-content; padding: 10px 20px; border-radius: 20px; font-family: Roboto, sans-serif; background-color: rgba(1, 1, 1, 1); color: white;">Save</button>
            <button type="button" class="cancelPlaylist" id="cancelPlaylist" style="width: 80%; height: fit-content; padding: 10px 20px; border-radius: 20px; font-family: Roboto, sans-serif; background-color: red; color: white;" onclick="document.getElementById('edit_playlist_popup').style.display='none'">Cancel</button>
        </div>
    </div>
    ...
    <script src="./js/change-playlist.js"></script>
    <script>
        // JS cho nút Play All
