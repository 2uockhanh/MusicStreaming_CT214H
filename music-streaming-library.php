            ...
            <nav class="navbar">
                ...
                <div class="nav">
                    <table>
                        ...
                        <!--
                        <tr>
                            <button class="nav_button" onclick="document.location='./music-streaming-favourite.html'">
        ...
        <div class="home">
            ...
            <div class="show_your_playlist">
                <div class="show_your_playlist_head">
                    <h3>YOUR PLAYLIST</h3>
                    <a class="add_playlist_btn" id="add_playlist_btn">
                ...
                <div class="show_your_favourite_body">
                    ...
                    <div class="show_body_grid" style="color: white; font-family: Tahoma, sans-serif;">
                        <!-- PLAYLIST 1 -->
                        <button class="your_favourite_nav">
            ...
            <div class="show_your_favourite">
                ...
                <div class="show_your_favourite_body">
                    ...
                    <div class="show_body_grid" style="color: white; font-family: Roboto, sans-serif;">
                        <!-- SONG 1 -->
                        <button class="your_favourite_nav">
                ...
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        ...
                        <ul>
                            ...
                            <li><a href="./music-streaming-import-music.php">Import Music</a></li>
                        </ul>
                    </div>
                    <div class="footer-section">
                        <h4>Social Links</h4>
    ...
    <div class="add_playlist_popup" id="add_playlist_popup">
        ...
        <div style="grid-template-columns: 240px 330px; gap: 30px; display: grid;">
            ...
            <div style="font-family: Roboto, sans-serif;">
                ...
                <input type="text" style="width: 300px; height: 30px; border-radius: 30px; background-color: rgba(217, 217, 217, 1); color: black; padding-left: 10px;">
        ...
        <div style="grid-template-columns: 240px 150px 150px; gap: 30px; display: grid; margin-top: 10px;">
            <button class="changeSeenMode" id="changeSeenMode">🔒 Private</button>
            <button style="width: 80%; height: fit-content; padding: 10px 20px; border-radius: 20px; font-family: Roboto, sans-serif; background-color: rgba(1, 1, 1, 1); color: white;">Create</button>
            <button style="width: 80%; height: fit-content; padding: 10px 20px; border-radius: 20px; font-family: Roboto, sans-serif; background-color: red; color: white;">Cancel</button>
        </div>
    </div>
